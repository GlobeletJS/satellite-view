...
`;
  ...
  const maxMercLat$1 = 2.0 * atan(exp(PI)) - PI / 2.0;
  const clipLat = (lat) => min(max(-maxMercLat$1, lat), maxMercLat$1);
  const degrees$1 = 180.0 / PI;
    ...
    switch (units) {
      ...
      case "degrees":
        return {
          ...
          scale: (pt) => scale(pt.map(c => c / degrees$1)),
        };
      default:
